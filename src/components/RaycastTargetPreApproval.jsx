...
const RaycastTargetPreApproval = ({handleClick}) => {
    ...
    useEffect(() => {
        ...
        const onPointerDown = (e) => {
            handleClick(e, camera, sphereRef, "preapproval");
        };
    ...
    return (
        <mesh
            ref={sphereRef}
            position={[-1, 1, 4]} // Position of the sphere
            onClick={(e) => handleClick(e, camera, sphereRef, "preapproval")}
        >
...
export default RaycastTargetPreApproval